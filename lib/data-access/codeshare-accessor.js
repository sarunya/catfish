...
class CodeshareAccessor extends PgModel2 {
    constructor(dependencies) {
        super(dependencies);
        this.tableName = Constants.TableNames.UserCodeshareData;
    ...
    async getByFirebaseId(firebaseId) {
        const me = this;
        let result = await me.filter(me.baseUserCommands.filterByFirebaseId, [identityId]);
        console.log("getByFirebaseId", JSON.stringify(result, null, 10));
        return result;
    }
...
module.exports = CodeshareAccessor;